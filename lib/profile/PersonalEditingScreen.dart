...
class _PersonalEditingScreenState extends State<PersonalEditingScreen> {
  final _nameController  = TextEditingController(text: 'Dang bao bao');
  final _emailController = TextEditingController(text: 'dangdinhbao0318@gmail.com');
  final _dobController   = TextEditingController(text: '18/02/2002');
